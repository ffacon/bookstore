    ...
    describe('ProductComment Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/product-comments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ProductComment', () => {
                service.create(new ProductComment(null)).subscribe(received => {
            ...
            it('should update a ProductComment', () => {
                service.update(new ProductComment(123)).subscribe(received => {
            ...
            it('should return a ProductComment', () => {
            ...
            it('should return a list of ProductComment', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ProductComment(123)]);
            });
