...
import com.worldline.bookstoreine.repository.ProductRepository;
...
public class ProductResourceIntTest {
    ...
    private static final String DEFAULT_MAIN_PICTURE = "AAAAAAAAAA";
    private static final String UPDATED_MAIN_PICTURE = "BBBBBBBBBB";
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .mainPicture(DEFAULT_MAIN_PICTURE);
        return product;
    }
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getAuthor()).isEqualTo(DEFAULT_AUTHOR);
        ...
        assertThat(testProduct.getMainPicture()).isEqualTo(DEFAULT_MAIN_PICTURE);
    }
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct
            ...
            .mainPicture(UPDATED_MAIN_PICTURE);
        ...
        assertThat(testProduct.getAuthor()).isEqualTo(UPDATED_AUTHOR);
        ...
        assertThat(testProduct.getMainPicture()).isEqualTo(UPDATED_MAIN_PICTURE);
    }
